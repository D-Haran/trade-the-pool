...
import { databaseUrl, redisUrl } from './e2e/database';
...
export default defineConfig({
  ...
  webServer: [
    ...
    {
      command: `NEXT_DIST_DIR=.next-e2e NEXT_PUBLIC_API_URL=${apiUrl} pnpm --filter @trade-the-pool/web dev --port ${webPort}`,
      cwd: '../..',
      url: webUrl,
      reuseExistingServer: true,
      timeout: 60_000,
